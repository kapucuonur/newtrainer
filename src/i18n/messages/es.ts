...
export const es: Messages = {
  ...
  'bt.androidWebView':
    'Este shell de Android usa WebView sin Web Bluetooth. Abre ROADLAB en Chrome Android para FTMS/HR, o espera el build con plugin BLE nativo.',
  'bt.androidHint':
    'Web Bluetooth necesita Chrome o Edge en Android (HTTPS). Concede Bluetooth (y Ubicación en Android antiguo) cuando se solicite.',
  ...
  'erg.modeErg': 'Objetivo ERG',
  'erg.unsupported':
    'Este rodillo no tiene potencia objetivo FTMS. El objetivo se muestra en el HUD para autorregular; SIM/resistencia del mapa sigue activo.',
  'erg.unsupportedHint': 'El rodillo no admite ERG por hardware',
  'erg.hardwareActive': 'ERG por hardware activo — envío de pendiente del mapa en pausa.',
  'erg.noTrainer': 'Conecta un rodillo para fijar vatios. El objetivo sigue en el HUD.',
  'erg.presets': 'Presets de % FTP',
  'erg.targetWatts': 'Vatios objetivo',
  'erg.apply': 'Aplicar',
  ...
  'hud.trainerErg': 'Objetivo ERG',
  'hud.targetPower': 'Objetivo',
  'hud.effortTarget': 'Objetivo de esfuerzo',
  'hud.ergActive': 'ERG',
  'hud.effortPace': 'Autorregular',
  'hud.trainerTargetAria': 'Pendiente en vivo y objetivo del trainer',
  'hud.climb': 'Subida',
  'hud.descent': 'Bajada',
  'hud.collapseAria': 'Contraer el HUD de la ruta',
  'hud.expandAria': 'Expandir el HUD de la ruta',
