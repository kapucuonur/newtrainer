...
export const de: Messages = {
  ...
  'erg.modeErg': 'ERG-Ziel',
  'erg.unsupported':
    'Dieser Trainer hat keine FTMS-Zielleistung. Ziel erscheint im HUD zum Selbsttempo; Karten-SIM/Widerstand bleibt aktiv.',
  'erg.unsupportedHint': 'Trainer unterstützt kein Hardware-ERG',
  'erg.hardwareActive': 'Hardware-ERG aktiv — Kartensteigungen pausiert.',
  'erg.noTrainer': 'Trainer verbinden, um Watt zu sperren. Ziel erscheint weiter im HUD.',
  'erg.presets': 'FTP-Prozentvorgaben',
  'erg.targetWatts': 'Zielwatt',
  'erg.apply': 'Übernehmen',
  ...
  'hud.trainerErg': 'ERG-Ziel',
  'hud.targetPower': 'Ziel',
  'hud.effortTarget': 'Anstrengungsziel',
  'hud.ergActive': 'ERG',
  'hud.effortPace': 'Selbsttempo',
