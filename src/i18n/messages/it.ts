...
export const it: Messages = {
  ...
  'bt.androidWebView':
    'Questo shell Android usa una WebView senza Web Bluetooth. Apri ROADLAB in Chrome Android per FTMS/HR, oppure attendi il build con plugin BLE nativo.',
  'bt.androidHint':
    'Web Bluetooth richiede Chrome o Edge su Android (HTTPS). Consenti Bluetooth (e Posizione su Android meno recenti) quando richiesto.',
  ...
  'erg.modeErg': 'Target ERG',
  'erg.unsupported':
    'Questo trainer non ha target power FTMS. Il target resta sul HUD per autogestione; SIM/resistenza mappa restano attivi.',
  'erg.unsupportedHint': 'Il trainer non supporta ERG hardware',
  'erg.hardwareActive': 'ERG hardware attivo — invio pendenza mappa in pausa.',
  'erg.noTrainer': 'Collega un trainer per bloccare i watt. Il target resta sul HUD.',
  'erg.presets': 'Preset % FTP',
  'erg.targetWatts': 'Watt target',
  'erg.apply': 'Applica',
  ...
  'route.roundTripShort': 'Stessa strada indietro',
  ...
  'hud.time': 'Tempo',
  'hud.trainerSim': 'Pendenza SIM',
  'hud.trainerRes': 'Resistenza',
  'hud.trainerErg': 'Target ERG',
  'hud.targetPower': 'Target',
  'hud.effortTarget': 'Target sforzo',
  'hud.ergActive': 'ERG',
  'hud.effortPace': 'Autogestione',
