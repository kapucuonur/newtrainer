...
export const no: Messages = {
  ...
  'bt.androidWebView':
    'Dette Android-app-skallet bruker en WebView uten Web Bluetooth. Åpne ROADLAB i Chrome Android for FTMS/HR, eller vent på native BLE-plugin-bygget.',
  'bt.androidHint':
    'Web Bluetooth trenger Chrome eller Edge på Android (HTTPS). Gi Bluetooth (og posisjon på eldre Android) når du blir bedt om det.',
  ...
  'erg.modeErg': 'ERG-mål',
  'erg.unsupported':
    'Denne traineren har ikke FTMS-måleffekt. Målet vises på HUD for selvtempo; kart-SIM/motstand forblir aktiv.',
  'erg.unsupportedHint': 'Trainer støtter ikke maskinvare-ERG',
  'erg.hardwareActive': 'Maskinvare-ERG aktiv — kartstigning pauset.',
  'erg.noTrainer': 'Koble til en trainer for å låse watt. Målet vises fortsatt på HUD.',
  'erg.presets': 'FTP-prosentforhåndsvalg',
  ...
  'hud.trainerRes': 'Motstand',
  'hud.trainerErg': 'ERG-mål',
  'hud.targetPower': 'Mål',
  'hud.effortTarget': 'Innsatsmål',
  'hud.ergActive': 'ERG',
